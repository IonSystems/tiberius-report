...
\newglossaryentry{controlpi}{
	name={Control Pi},
    description={is the Raspberry Pi running all control/database/navigation software}
}

\newglossaryentry{controlapi}{
	name={Control API},
    description={is a web application developed to allow external applications to interact with Tiberius.}
}

\newglossaryentry{yocto}{
	name={Yocto},
    description={is an open source embedded Linux project, providing tools to create custom Linux distributions for embedded systems}
}

\newglossaryentry{POST}{
	name={POST},
    description={is a HTTP request method where the body of the message is accessed by the destination server and the data stored}
}

\newglossaryentry{webinterface}{
	name={Web interface},
    description={is a web application that tele-operates Tiberius, and manages Tiberius' missions}
}

\newglossaryentry{method}{
	name={Method},
    description={is a function within a class, distinguished by the \texttt{self} parameter}
}
...
\newglossaryentry{python}{
	name={Python},
    description={is a duck typed programming language with an efficient and readable syntax}
}
...
\newglossaryentry{ultrasonicsensor}{
    ...
    description={is a rangefinder capable of sensing distances between 0 and 30cm}
}
\newglossaryentry{RPi}{
	name={Raspberry Pi},
...
\newglossaryentry{citadel}{
	name={Citadel},
    description={Tiberius II's central power bank}
}
...
\newglossaryentry{scintered}{
	name={Scintered bearing},
    description={Scintered bearings are used whenever particularly low noise levels are required, loads are variable or little space is available. They consist of pressed metal powder whose pores are impregnated with a lubricant. The impregnating oil or fluid ensures permanent lubrication of the bearings.}
}

\newglossaryentry{PLA}{
	name={PLA},
    description={Polylactic Acid, a biodegradable thermoplastic commonly used by 3D printers.}
}

\newglossaryentry{Acetal}{
	name={Acetal},
    description={Acetal is a plastic providing high strength and stiffness coupled with good dimensional stability and ease of machining.}
}
...
\newglossaryentry{a-star}{
	name={A Star},
    description={is a search algorithm using heuristics to determine the shortest path}
}
...
\newglossaryentry{PyPI}{
	name={PyPI},
    description={is a package manager for Python projects (Python Package Index).}
}
...
\newglossaryentry{MPEG-2}{
	name={MPEG-2},
    description={is a lossy video compression standard.}
}
\newglossaryentry{i2c}{
...
\newglossaryentry{tiberius3}{
	name={Tiberius III},
    description={is the third development iteration of the Tiberius robot}
}
...
\newglossaryentry{UDP}{
	name={UDP},
    description={User Datagram Protocol (UDP) is one of the core members of the Internet protocol suite}
}
%*********************************************************************
%**************************** CommsKing ******************************
%*********************************************************************
...
\newacronym{IRED}{IRED}{Infra-red Emitting Diode}
\newacronym{CI}{CI}{Continuous Integration}
\newacronym{DBMS}{DBMS}{Database Management System}

 \newdualentry{APT} % label
  {APT}            % abbreviation
  {Advanced Packaging Tool}  % long form
  {is a Linux core library installation tool} % description
